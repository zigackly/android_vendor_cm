...
ifdef CM_BUILDTYPE
    ...
    # If CM_BUILDTYPE is not defined, set to my version
    CM_BUILDTYPE := ZIGACKLY
...
ifdef CM_RELEASE
    ...
    CM_MYDATE := $(shell date -u +%Y%m%d)
    CM_VERSION := $(PRODUCT_VERSION_MAJOR)-$(CM_MYDATE)-$(CM_BUILDTYPE)-$(CM_BUILD)-$(CM_EXTRAVERSION)
endif
